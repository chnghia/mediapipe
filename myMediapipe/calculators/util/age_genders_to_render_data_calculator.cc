...
// Usage example:
// node {
//   calculator: "AgeGendersToRenderDataCalculator"
//   input_stream: "AGEGENDERS:agegenders"
//   output_stream: "VIDEO_PRESTREAM:video_header"
//   options {
//     [AgeGendersToRenderDataCalculatorOptions.ext] {
//       color { r: 255 g: 0 b: 0 }
//       color { r: 0 g: 255 b: 0 }
//       color { r: 0 g: 0 b: 255 }
//       thickness: 2.0
...
//   }
// }
class AgeGendersToRenderDataCalculator : public CalculatorBase {
 public:
 ...
 private:
  AgeGendersToRenderDataCalculatorOptions options_;
  int num_colors_ = 0;
  int video_width_ = 0;
  int video_height_ = 0;
...
REGISTER_CALCULATOR(AgeGendersToRenderDataCalculator);
...
mediapipe::Status AgeGendersToRenderDataCalculator::Open(CalculatorContext* cc) {
  cc->SetOffset(TimestampDiff(0));
  options_ = cc->Options<AgeGendersToRenderDataCalculatorOptions>();
  num_colors_ = options_.color_size();
  label_height_px_ = std::ceil(options_.font_height_px() * kFontHeightScale);
  return mediapipe::OkStatus();
}

mediapipe::Status AgeGendersToRenderDataCalculator::Process(CalculatorContext* cc) {
  if (cc->Inputs().HasTag("VIDEO_PRESTREAM") &&
    ...
    CHECK_EQ(options_.location(), AgeGendersToRenderDataCalculatorOptions::TOP_LEFT)
  ...
  if (options_.location() == AgeGendersToRenderDataCalculatorOptions::TOP_LEFT) {
    label_baseline_px += label_height_px_;
             ...
             AgeGendersToRenderDataCalculatorOptions::BOTTOM_LEFT) {
